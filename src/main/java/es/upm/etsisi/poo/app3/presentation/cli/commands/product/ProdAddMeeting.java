...
/**
 * Command that adds a new {@link TimeProduct} of type {@link TimeProductType#MEETING}.
 * <p>
 * This command creates a time-dependent meeting product with an event/open date and
...
public class ProdAddMeeting implements Command {
    ...
    /**
     * Creates a new {@code prod addMeeting} command.
     *
     * @param view               the view used to display output
     * @param purchasableService the service used to add purchasables
     */
    public ProdAddMeeting(View view, PurchasableService purchasableService) {
     ...
     *
     * @return the string {@code "prod addMeeting"}
     */
    @Override
    public String name() {
    ...
    /**
     * Executes the command by creating and persisting a meeting time product.
     *
     * @param params raw parameters provided by the user
     */
    @Override
